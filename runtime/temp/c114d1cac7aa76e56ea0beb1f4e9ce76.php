<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"F:\web\www\o2o\public/../application/admin\view\order\index.html";i:1515566801;s:56:"F:\web\www\o2o\application\admin\view\public\header.html";i:1514704735;s:56:"F:\web\www\o2o\application\admin\view\public\footer.html";i:1514704688;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if(is_array($orders) || $orders instanceof \think\Collection || $orders instanceof \think\Paginator): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td><?php echo $vo->deal_id; ?></td>
				<td><?php echo $vo->user_id; ?></td>
				<td><?php echo $vo->username; ?></td>
				<td><?php echo $vo->deal_count; ?></td>
				<td><?php echo $vo->total_price; ?></td>
				<td><?php echo date("y-m-d h:i",$vo['create_time']); ?></td>
				<td class="td-status"><a><?php echo pay_status($vo['pay_status']); ?></a></td>
