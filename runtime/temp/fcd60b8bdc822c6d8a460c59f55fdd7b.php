<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"F:\web\www\o2o\public/../application/admin\view\user\index.html";i:1515556676;s:56:"F:\web\www\o2o\application\admin\view\public\header.html";i:1514704735;s:56:"F:\web\www\o2o\application\admin\view\public\footer.html";i:1514704688;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if(is_array($users) || $users instanceof \think\Collection || $users instanceof \think\Paginator): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td class="text-l"><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></td>
				<td class="text-l"><?php echo date('Y-m-d H:i:s',$vo['update_time']); ?></td>
