<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\web\www\o2o\public/../application/admin\view\bis\index.html";i:1514704441;s:56:"F:\web\www\o2o\application\admin\view\public\header.html";i:1514704735;s:56:"F:\web\www\o2o\application\admin\view\public\footer.html";i:1514704688;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 商户数据 </nav>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tr class="text-c">
				...
				<td class="td-status" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
				<td class="td-manage">
					<a style="text-decoration:none" class="ml-5" onClick="o2o_edit('商户入驻详请数据','<?php echo url('bis/detail',['id'=>$vo['id']]); ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
