<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"F:\web\www\o2o\public/../application/admin\view\deal\index.html";i:1520668119;s:56:"F:\web\www\o2o\application\admin\view\public\header.html";i:1514704735;s:56:"F:\web\www\o2o\application\admin\view\public\footer.html";i:1514704688;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	<div class="text-c">
		...
		<input type="text" name="end_time" class="input-text" id="countTimeend" onfocus="selecttime(1)" value="<?php echo $end_time; ?>"  style="width:120px;">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td><?php echo date('Y-m-d h-i',$vo['coupons_begin_time']); ?><br /><?php echo date('Y-m-d h-i',$vo['coupons_end_time']); ?></td>
