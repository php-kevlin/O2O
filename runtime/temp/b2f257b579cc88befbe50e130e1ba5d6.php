<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\web\www\o2o\public/../application/index\view\detail\index.html";i:1514900934;s:56:"F:\web\www\o2o\application\index\view\public\header.html";i:1515037672;s:53:"F:\web\www\o2o\application\index\view\public\nav.html";i:1514882993;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="p-detail">
    <div class="p-bread-crumb">
        <div class="w-bread-crumb">
            <ul class="crumb-list">
                ...
                <li class="crumb crumb-last"><a><?php echo $location[0]->name; ?></a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="p-item-info">
        <div class="w-item-info">
            <h2><?php echo $location[0]->name; ?></h2>
                        ...
                        <div class="buy-panel">
                            ...
                            <div class="item-buy-area">
                                <div style="float:left" class="static-hook-real static-hook-id-12">
                                    <?php if($flag): ?>
                                    <a class="btn-buy btn-buy-qrnew j-btn-buy btn-hit"
                                       style="background: #c0c0c0 ;border-bottom :darkgray">立即抢购</a>
                                    <?php else: ?>
                                    <a href="<?php echo url('order/confirm',['id'=>$deal['id']]); ?>" class="btn-buy btn-buy-qrnew j-btn-buy btn-hit">立即抢购</a>
                                    <?php endif; ?>
